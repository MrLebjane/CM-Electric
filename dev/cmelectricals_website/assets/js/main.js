...
function redirectToHomePage() {
  // Replace "your_homepage_url" with the actual URL of your home page
...
function OpenBookForm(){
  document.getElementById("trackformid").style.display = "none";
...
function closeStatusForm(){
  document.getElementById("trackstatusformid").style.display = "none";
}
