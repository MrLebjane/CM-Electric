...
import { getDataFromStorage,setDataToStorage,STORAGE_CLIENTBOOKID,STORAGE_TECH} from './DataStorage';

import axios from 'axios';
 

const AppointmentViewer = ({route}) => {
 ...
 getClients();
  ...
  const renderAppointmentItem = ({ item }) => {
    const handleViewPress = () => {
      ...
      setDataToStorage(STORAGE_CLIENTBOOKID,item.book_ID)
